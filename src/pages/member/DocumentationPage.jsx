...
import account       from './docs/account.md?raw'
import profile       from './docs/profile.md?raw'
import password      from './docs/password.md?raw'
import notification  from './docs/notification.md?raw'
import faq           from './docs/faq.md?raw'
import cpd           from './docs/cpd.md?raw'
import cpdSubmit     from './docs/cpd-submit.md?raw'
import cpdHistory    from './docs/cpd-history.md?raw'
import renewal       from './docs/renewal.md?raw'
import renewalStatus from './docs/renewal-status.md?raw'
import payment       from './docs/payment.md?raw'
import pathway       from './docs/pathway.md?raw'
import education     from './docs/education.md?raw'
import exam          from './docs/exam.md?raw'
import examSchedule  from './docs/exam-schedule.md?raw'
import examResult    from './docs/exam-result.md?raw'
import certification from './docs/certification.md?raw'
import ethics        from './docs/ethics.md?raw'
import standard      from './docs/standard.md?raw'
import disciplinary  from './docs/disciplinary.md?raw'
import code          from './docs/code.md?raw'
import download      from './docs/download.md?raw'
import forms         from './docs/forms.md?raw'
import policy        from './docs/policy.md?raw'
import contact       from './docs/contact.md?raw'
import support       from './docs/support.md?raw'
import faqGeneral    from './docs/faq-general.md?raw'
